...
def run_test(args, model_name, ckpt_path):
    ...
    if args.useSoftHard:
        ...
        train_idx = "/p/project/hai_drug_qm/atom3d/examples/lba_md/data/new_split/test_soft_hard_lite.txt"
        val_idx = "/p/project/hai_drug_qm/atom3d/examples/lba_md/data/new_split/test_soft_hard_lite.txt"
        test_idx = "/p/project/hai_drug_qm/atom3d/examples/lba_md/data/new_split/test_soft_hard_lite.txt"
    ...
    test_loader = DataLoader(test_dataset, 1, shuffle=False, num_workers=16)
    ...
    for prediction in predictions:
        ...
        for pred, target in zip(preds, targets):
            ...
            temp_data = [pred.item(), target.item()]
            #frame += 1
            counter += 1
            test_results.append(temp_data)

    # Create the pandas DataFrame
    df = pd.DataFrame(test_results, columns=['prediction', 'target'])
...
if __name__=="__main__":
    ...
    #     break
    model_name = 'gnn_CA_False_Pocket_False_SoftHard_True.ckpt'
    args.ckpt_path = f'/p/project/hai_drug_qm/atom3d/examples/lba_md/gnn/model_ckpts/2022-12-21-10-50-08/model_ckpts/gnn_CA_False_Pocket_False_SoftHard_True.ckpt'
